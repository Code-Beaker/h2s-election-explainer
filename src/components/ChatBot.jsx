...
const ChatBot = () => {
  ...
  const handleNewChat = () => {
    const newChat = { id: Date.now(), title: 'New Chat', messages: initialMessages };
      ...
      <main className="chat-main-area">
        ...
        <div className="chat-messages-container" ref={messagesContainerRef}>
          {messages.length === 0 ? (
            <div className="empty-state">
              ...
              <h2>Hello, Voter</h2>
              <p>How can I help you understand the election process today?</p>
            </div>
          ) : (
              ...
              {messages.map(msg => (
                <div key={msg.id} className={`message-row ${msg.type}`}>
                  <div className="message-avatar">
                    {msg.type === 'bot' ? <Bot size={20} color="white" /> : <User size={20} color="white" />}
                  </div>
        ...
        <div className="chat-input-wrapper">
          <div className="quick-replies">
            <button onClick={() => handleSend("How to register?")}>How to register?</button>
            <button onClick={() => handleSend("Documents needed")}>Documents needed</button>
            <button onClick={() => handleSend("How EVMs work?")}>How EVMs work?</button>
          </div>
          ...
          <div className="disclaimer">
            CivicBot is an educational assistant and can make mistakes. Please verify important information on the official ECI website.
          </div>
        </div>
      </main>
    </div>
